...
| Ajustar saldo desde una cuenta | ☐ | ☐ | Permite elegir `+ Sumar saldo` o `− Restar saldo` sin depender del signo del teclado; cambia esa cuenta y no cuenta como ingreso/gasto |
