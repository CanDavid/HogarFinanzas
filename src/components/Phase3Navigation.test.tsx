...
describe('Phase 3 navigation and movements', () => {
  ...
  it('does not allow editing or deleting movements from a closed month', () => {
    const month = localDateOnly().slice(0, 7); const onDelete = vi.fn()
    const closure = { ...sync, id: 'closure', createdBy: 'david' as const, month, status: 'closed' as const, revision: 1,
