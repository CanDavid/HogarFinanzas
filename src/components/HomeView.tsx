...
import type { Account, Category, Goal, GoalAllocation, MonthlyClosure, Transaction } from '../domain/types'

export function HomeView({ transactions, accounts, categories, goals, allocations, closures, onAddMovement, onOpenMovements, onOpenPortfolio, onOpenGoals, onOpenAccounts, onOpenCategories }: {
